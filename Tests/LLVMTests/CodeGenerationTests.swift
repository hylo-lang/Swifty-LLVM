...
extension Module {
  ...
  private mutating func emitMain(
    ...
    insertStore(double.unsafe[].constant(.pi), to: x1, at: endOf(b0))
    ...
    let x6 = insertFSub(x5, double.unsafe[].constant(180), at: endOf(b0))
    ...
    let x9 = insertFloatingPointComparison(
      .ueq, x8, double.unsafe[].constant(0), at: endOf(b0))
  ...
  private mutating func emitProjectDegrees() throws -> Function.UnsafeReference {
    ...
    let i32_16 = i32.unsafe[].constant(16)
    let i32_8 = i32.unsafe[].constant(8)
    ...
    let x2 = insertFMul(x1, double.unsafe[].constant(180), at: endOf(b0))
    let x3 = insertFDiv(x2, double.unsafe[].constant(.pi), at: endOf(b0))
    ...
    let x5 = insertFMul(x4, double.unsafe[].constant(.pi), at: endOf(b0))
    let x6 = insertFDiv(x5, double.unsafe[].constant(180), at: endOf(b0))
  ...
  private mutating func emitTestAtomics() throws -> Function.UnsafeReference {
    ...
    let x1 = insertAlloca(double, at: endOf(b0))
    let pi = double.unsafe[].constant(.pi)
    let i64_11 = i64.unsafe[].constant(11)
    let i64_13 = i64.unsafe[].constant(13)
    let i64_17 = i64.unsafe[].constant(17)
    let i64_19 = i64.unsafe[].constant(19)
    let i64_23 = i64.unsafe[].constant(23)
    let i64_29 = i64.unsafe[].constant(29)
    let i64_31 = i64.unsafe[].constant(31)
    let i64_37 = i64.unsafe[].constant(37)
    let i64_41 = i64.unsafe[].constant(41)
    let i64_43 = i64.unsafe[].constant(43)
