...
public struct FloatingPointType: IRType, Hashable {
  ...
  public static func float(in module: inout Module) -> FloatingPointType.Reference {
    .init(LLVMFloatTypeInContext(module.context))
  }

  /// Returns the type `double` in `module`
  public static func double(in module: inout Module) -> FloatingPointType.Reference {
    .init(LLVMDoubleTypeInContext(module.context))
  }

  /// Returns the type `fp128` in `module`
  public static func fp128(in module: inout Module) -> FloatingPointType.Reference {
  ...
  public func callAsFunction(_ v: Double)
    -> FloatingPointConstant.Reference
  {
    constant(v)
  }

  /// Returns a constant whose LLVM IR type is `self` and whose value is `v`.
  public func constant(_ v: Double) -> FloatingPointConstant.Reference {
  ...
  public var zero: FloatingPointConstant.Reference {
